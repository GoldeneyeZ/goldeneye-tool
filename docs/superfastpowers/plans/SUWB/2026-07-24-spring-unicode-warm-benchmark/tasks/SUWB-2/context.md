...
- `tools/agent-bench/bin/benchmark-agent-tasks.mjs`: existing scored-run orchestration and Codex process launch.
...
- Files modified: `tools/agent-bench/core.mjs`, `tools/agent-bench/core.test.mjs`, `tools/agent-bench/bin/benchmark-agent-tasks.mjs`
