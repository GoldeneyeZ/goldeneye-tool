...
- Additional relevant files: `tools/agent-bench/core.mjs`, `tools/agent-bench/bin/benchmark-agent-tasks.mjs`, and pinned Spring `StringUtils.java` / `StringUtilsTests.java` inspected only.
