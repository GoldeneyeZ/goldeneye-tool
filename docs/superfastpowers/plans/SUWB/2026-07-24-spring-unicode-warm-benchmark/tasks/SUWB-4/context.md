...
- `tools/benchmark-agent-tasks.mjs`: preparation, smoke, and verification entrypoints.
...
- Files modified: `tools/benchmark-agent-tasks.mjs`, `tools/agent-bench/core.mjs`, `tools/agent-bench/core.test.mjs`, `tools/agent-bench/snapshot.mjs`, Goldeneye runtime/index/bootstrap/CLI crates, benchmark config and prompt
