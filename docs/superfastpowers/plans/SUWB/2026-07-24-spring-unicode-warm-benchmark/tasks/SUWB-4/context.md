...
- `D:\Dev\IdeaProjects\goldeneye-tool\agent`: frozen GCAL candidate repository.
...
- Notes: Path-exact file-node identity removed the duplicate-node blocker. Runtime SQLite quiescence, GCAL shutdown tolerance, bounded full-Java grammar selection, exact two-file discovery filtering, worktree readiness/cleanup retries, and evidence-preserving failures made preparation repeatable. Snapshot manifest SHA-256 used for scoring: `b60ce99c815bca2930e6d12d7fca2ce466ebadb219219f34a4a8adcece10ea22`.
